...
int gpio2_value, gpio4_value, gpio0_value, ultrasonic_value;
...
void loop()
{
    ...
    if (client)
    {
        ...
        {
            String response = "{\"gpio2Status\":\"" + String(gpio2_value == 1 ? "ON" : "OFF") + "\",";
            response += "\"gpio2Color\":\"" + String(gpio2_value == 1 ? "green" : "red") + "\",";
            response += "\"gpio0Status\":\"" + String(gpio0_value == 0 ? "ON" : "OFF") + "\",";
            response += "\"gpio0Color\":\"" + String(gpio0_value == 0 ? "green" : "red") + "\",";
            response += "\"gpio4Status\":\"" + String(gpio4_value == 0 ? "ON" : "OFF") + "\",";
            response += "\"gpio4Color\":\"" + String(gpio4_value == 0 ? "green" : "red") + "\",";
            response += "\"analog0Value\":\"" + String(ultrasonic_value) + "\"}";
        ...
        else
        {
            ...
            <script>
                ...
                document.getElementById('analog0Value').innerHTML = ')" +
                                String(ultrasonic_value) + R"(';
            </script>
            )";
            client.print(script.c_str());
