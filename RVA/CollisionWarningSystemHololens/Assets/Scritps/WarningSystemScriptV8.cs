...
public class WarningSystemScriptV8 : MonoBehaviour
{
    ...
    public void DisplayWarningSystemWithXRay()
    {
        ...
        cameraBearing = (mrCamera.transform.rotation.eulerAngles.y + cameraBearingOffset + 360) % 360;
        ...
        if (!isInstantiated)
        {
            ...
            // Instantiate the car GameObject for XRay
            ...
            carInstance.transform.position =CalculatePositionBasedOnLatLong(vamLatitude, vamLongitude, camLatitude, camLongitude);
        ...
        carInstance.transform.position = new Vector3(carInstance.transform.position.x, 0, carInstance.transform.position.z);
        carInstance.transform.rotation = Quaternion.Euler(carInstance.transform.rotation.x, 80, carInstance.transform.rotation.z);
    ...
    private Vector3 CalculatePositionBasedOnLatLong(double vamLat, double vamLon, double camLat, double camLon)
    {
        ...
        */
        ...
        position = mrCamera.transform.TransformPoint(position);
    ...
    public void SetHeading(float heading)
    {
        ...
        GameObject mrCamera = GameObject.Find("MRTK XR Rig/Camera Offset/Main Camera");
        cameraBearingOffset = heading - mrCamera.transform.rotation.eulerAngles.y;
    }
